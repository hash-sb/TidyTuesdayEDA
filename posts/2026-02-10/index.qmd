...
categories:
- Schedule
description: Olympics Schedule and Results
---
...
**Data source:** [Milano-Cortina 2026 Winter Olympics Data](https://raw.githubusercontent.com/chendaniely/olympics-2026/refs/heads/main/data/final/olympics/olympics_events.csv)  
**Original article:** [Olympics Schedule and Results](https://www.olympics.com/en/milano-cortina-2026/schedule)  
**Curated by:** Daniel Chen, Posit PBC, University of British Columbia  

```{r}
#| output: asis
tt_dataset_section("2026-02-10", "schedule", "Schedule")
```
