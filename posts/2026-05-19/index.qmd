...
date: '2026-05-19'
categories:
- Member Participation Stats By Country
- Metadata Coverage Stats By Country
description: 2026 public data file now available (Crossref blog)
---
...
**Data source:** [State of Crossref metadata by member country](https://zenodo.org/records/19928426)  
**Original article:** [2026 public data file now available (Crossref blog)](https://doi.org/10.64000/7s70g-drz77)  
**Curated by:** Crossref  

```{r}
#| output: asis
tt_dataset_section("2026-05-19", "member_participation_stats_by_country", "Member Participation Stats By Country")
```
```{r}
#| output: asis
tt_dataset_section("2026-05-19", "metadata_coverage_stats_by_country", "Metadata Coverage Stats By Country")
```
