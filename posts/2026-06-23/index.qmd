...
description: Magnifica Humanitas - Encyclical Letter of Pope Leo XIV
---
...
The data comes from [Vatican.va](https://www.vatican.va), the official website of the Holy See. A supplementary dataset catalogs all 213 papal encyclicals from 1878 to 2026 with metadata about each pope.
...
**Data source:** [The Holy See (Vatican.va)](https://www.vatican.va)  
**Original article:** [Magnifica Humanitas - Encyclical Letter of Pope Leo XIV](https://www.vatican.va/content/leo-xiv/en/encyclicals/documents/20260515-magnifica-humanitas.html)  
**Curated by:** Tony Galvan, Golden Dome Data Science  

```{r}
#| output: asis
tt_dataset_section("2026-06-23", "encyclicals", "Encyclicals")
```
```{r}
#| output: asis
tt_dataset_section("2026-06-23", "papal_encyclicals", "Papal Encyclicals")
```
```{r}
#| output: asis
tt_dataset_section("2026-06-23", "scripture_references", "Scripture References")
```
