...
date: '2026-08-11'
categories:
- Palomar Emission Lines
- Palomar Survey
description: Demographics of Nuclear Activity in Nearby Galaxies
---
...
**Data source:** [VizieR Astronomical Catalogs (Ho, Filippenko & Sargent 1995, 1997, 2009)](https://vizier.cds.unistra.fr/viz-bin/VizieR-2?-source=J/ApJS/112/315)  
**Original article:** [Demographics of Nuclear Activity in Nearby Galaxies](https://arxiv.org/abs/astro-ph/9704108)  
**Curated by:** Tony Galvan, Golden Dome Data Science  

```{r}
#| output: asis
tt_dataset_section("2026-08-11", "palomar_emission_lines", "Palomar Emission Lines")
```
```{r}
#| output: asis
tt_dataset_section("2026-08-11", "palomar_survey", "Palomar Survey")
```
