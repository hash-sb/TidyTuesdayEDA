...
categories:
- Africa
description: Languages of Africa
---
...
**Data source:** [Languages of Africa](https://en.wikipedia.org/wiki/Languages_of_Africa)  
**Original article:** [Languages of Africa](https://en.wikipedia.org/wiki/Languages_of_Africa)  
**Curated by:** Robert Muwanga, Data Enthusiast  

```{r}
#| output: asis
tt_dataset_section("2026-01-13", "africa", "Africa")
```
