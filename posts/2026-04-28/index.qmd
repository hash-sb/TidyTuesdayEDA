...
- Tariff Agricultural
- Tariff Codes
description: The Economic Impacts of Retaliatory Tariffs on U.S. Agriculture
---
...
**Data source:** [DataWeb: Annual Tariff Data](https://dataweb.usitc.gov/tariff/annual)  
**Original article:** [The Economic Impacts of Retaliatory Tariffs on U.S. Agriculture](https://ers.usda.gov/sites/default/files/_laserfiche/publications/102980/ERR-304.pdf?v=13480)  
**Curated by:** Jon Harmon, Data Science Learning Community  

```{r}
#| output: asis
tt_dataset_section("2026-04-28", "agreements", "Agreements")
```
```{r}
#| output: asis
tt_dataset_section("2026-04-28", "quantity_codes", "Quantity Codes")
```
```{r}
#| output: asis
tt_dataset_section("2026-04-28", "tariff_agricultural", "Tariff Agricultural")
```
```{r}
#| output: asis
tt_dataset_section("2026-04-28", "tariff_codes", "Tariff Codes")
```
