...
description: 'fightr: Analyze Fight Probabilities and Proportions via Statistical
  Frameworks'
---
...
**Data source:** [fightr: Analyze Fight Probabilities and Proportions via Statistical Frameworks](https://github.com/benyamindsmith/fightr/)  
**Original article:** [fightr: Analyze Fight Probabilities and Proportions via Statistical Frameworks](https://github.com/benyamindsmith/fightr/)  
**Curated by:** Benjamin Smith  

```{r}
#| output: asis
tt_dataset_section("2026-07-07", "ufc_athletes", "Ufc Athletes")
```
```{r}
#| output: asis
tt_dataset_section("2026-07-07", "ufc_fights", "Ufc Fights")
```
```{r}
#| output: asis
tt_dataset_section("2026-07-07", "ufc_rankings_dataset", "Ufc Rankings Dataset")
```
```{r}
#| output: asis
tt_dataset_section("2026-07-07", "ufcstats_data", "Ufcstats Data")
```
```{r}
#| output: asis
tt_dataset_section("2026-07-07", "ultimate_ufc_dataset", "Ultimate Ufc Dataset")
```
