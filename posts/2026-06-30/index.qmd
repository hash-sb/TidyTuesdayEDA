...
categories:
- Wreck Inventory
description: Wreck Inventory of Ireland
---
...
**Data source:** [Wreck Inventory of Ireland](https://data.gov.ie/dataset/national-monuments-service-wreck-inventory-of-ireland)  
**Original article:** [Wreck Inventory of Ireland](https://www.archaeology.ie/advice-and-support/locate-a-monument-or-wreck/wreck-viewer/)  
**Curated by:** Cormac Monaghan  

```{r}
#| output: asis
tt_dataset_section("2026-06-30", "wreck_inventory", "Wreck Inventory")
```
