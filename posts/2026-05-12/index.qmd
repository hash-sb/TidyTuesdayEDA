...
- Cities
- Links
description: Twin Cities Explorer
---
...
**Data source:** [Wikidata Query Service](https://query.wikidata.org/)  
**Original article:** [Twin Cities Explorer](https://bothness.github.io/twin-cities/)  
**Curated by:** Nicola Rennie  

```{r}
#| output: asis
tt_dataset_section("2026-05-12", "cities", "Cities")
```
```{r}
#| output: asis
tt_dataset_section("2026-05-12", "links", "Links")
```
