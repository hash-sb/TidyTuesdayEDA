...
categories:
- Many Penguins
description: 'AVONET: morphological, ecological and geographical data for all birds'
---
...
**Data source:** [AVONET: morphological, ecological and geographical data for all birds](https://opentraits.org/datasets/avonet.html)  
**Original article:** [AVONET: morphological, ecological and geographical data for all birds](http://dx.doi.org/10.1111/ele.13898)  
**Curated by:** Ben Bolker, McMaster University  

```{r}
#| output: asis
tt_dataset_section("2026-07-14", "many_penguins", "Many Penguins")
```
