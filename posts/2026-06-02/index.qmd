...
categories:
- Eplp
description: Tracking parenting leave policies in Europe over five decades
---
...
**Data source:** [The European Parenting Leave Policies (EPLP) Dataset](https://zenodo.org/records/17648712)  
**Original article:** [Tracking parenting leave policies in Europe over five decades](https://eplp-dataset.org/)  
**Curated by:** Nicola Rennie  

```{r}
#| output: asis
tt_dataset_section("2026-06-02", "eplp", "Eplp")
```
