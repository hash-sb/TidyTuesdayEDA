...
categories:
- Nde Experiences
description: Near Death Experience Research Foundation
---
...
**Data source:** [NDERF Search](https://search.nderf.org/)  
**Original article:** [Near Death Experience Research Foundation](https://nderf.org/)  
**Curated by:** Tony Galvan, Golden Dome Data Science  

```{r}
#| output: asis
tt_dataset_section("2026-07-21", "nde_experiences", "Nde Experiences")
```
